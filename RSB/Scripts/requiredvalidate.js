 ...
 var errorname;
    function validate(req)
    {
        ...
        var dob = $('#DOB').val();
        var dateofenrolment = $('#Date_of_Enrolment').val();
        if (name.length == 0 && fname.length == 0 && dob.length == 0 && mbno.length == 0  && armyno.length == 0 && esmino.length == 0
            && peraddno.length == 0 && gndr == 0 && cast == 0 && mat == 0 && reg == 0 && state == 0 && dist == 0 && tnme == 0 && twnme == 0 && dateofenrolment.length == 0) {
            ...
            if (name.length == 0) {
                ...
                errorname = "SanikName is not blank";
                ...
                if (fname.length == 0) {
                    ...
                    errorname = "Father name is not blank";
                    return true;
                }
                else {
                                    ...
                                    if (armyno.length == 0) {
                                        ...
                                        if (esmino.length == 0) {
                                            ...
                                            if (peraddno.length == 0) {
                                                errorname = "Permanent Address is not blank";
                                                ...
                                                if (gndr == 0) {
                                                    errorname = "Gender  is not slected";
                                                    ...
                                                    if (cast == '10') {
                                                        ...
                                                        if (mat == 0) {
                                                            ...
                                                            if (reg == 0) {
                                                                errorname = "Regiment/Corps is not selected";
                                                                        ...
                                                                        if (tnme == 0) {
                                                                            ...
                                                                            if (twnme == 0) {
                                                                                ...
                                                                                if ($('input[name=RadioRuralUrban]:checked').length <= 0) {
                                                                                    errorname = "Radio button of Urban and Rural is not selected";
                                                                                    ...
                                                                                    if ($('input[name=Disability]:checked').length <= 0) {
                                                                                        errorname = "Radio button of Disable Person is not selected";
                                                                                        return true;// $('#RadioRuralUrban').after('<div class="red">Selection required Name is Required</div>')
                                                                                    }
                                                                                    else {
                                                                                        if (dateofenrolment.length == 0) {
                                                                                            errorname = "Date of Enrolment  is not blank";
                                                                                            return true; // $('#DOB').after('<div class="red">DOB is Required</div>');
                                                                                        }
                                                                                        else {
...
//for DOB
    ...
    //$("#StateStatus").prepend('<option selected="selected" value="06">Harayana</option>');
       ...
       date_input.datepicker(options);
            ...
            $(document).ready(function () {
                var date_input = $('input[name="Date_of_Enrolment"]'); //our date input has the name "date"
                var container = $('.bootstrap-iso form').length > 0 ? $('.bootstrap-iso form').parent() : "body";
                var options = {
                    dateFormat: 'dd/mm/yy',
                    changeMonth: true,

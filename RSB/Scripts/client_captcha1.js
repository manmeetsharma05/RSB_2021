 ;(function(window, document, $, undefined) {
        ...
        var possibleCharacters = "ABCDEFGHJKLMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz123456789";
        ...
        CAPTCHA.prototype = {
            ...
            generate: function() {
                ...
                if (this._settings.randomColours) {
					...
					this._settings.colour3 = this._generateRandomColourwithopacity();
                    this._settings.colour4 = this._generateRandomColourwithopacity();
                }                
                ...
                var numRandomCurves = 4;//Math.floor((Math.random() * 3) + 5);
            ...
            validatereturn: function (userText) {
                if (userText === this._settings.text) {
                    return '1';
                } else {
                    return '2';
            ...
            _generateRandomColour: function() {
			 ...
			 _generateRandomColourwithopacity: function() {
                return "rgb(" + Math.floor((Math.random() * 255)) + ", " + Math.floor((Math.random() * 255)) + ", " + Math.floor((Math.random() * 255)) + ",0.2)";
            }
        };
